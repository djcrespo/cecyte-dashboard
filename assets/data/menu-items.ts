...
export const MENU_ITEMS: MenuItemType[] = [
  ...
  {
    key: 'convocations',
    icon: 'iconamoon:briefcase-bold',
    label: 'Convocatorias',
    children: [
      {
        key: 'convocations-list',
        label: 'Convocatorias',
        url: '/convocation/list',
        parentKey: 'convocation'
      },
      {
        key: 'convocations-persons',
        label: 'Postulados',
        url: '/convocation/persons',
        parentKey: 'convocation'
      },
      {
        key: 'convocations-persons',
