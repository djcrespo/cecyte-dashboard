        ...
        <div class="d-flex align-items-center gap-2">
          <div class="topbar-item">
            <button type="button" class="button-toggle-menu">
              <Icon name="iconamoon:menu-burger-horizontal" class="fs-22" @click="toggleLeftSideBar" />
            </button>
          </div>
        ...
        <div class="d-flex align-items-center gap-1">
          ...
          <div class="topbar-item">
            <button type="button" class="topbar-button" @click="toggleTheme">
              <Icon name="iconamoon:mode-dark-duotone" class="fs-24 align-middle" />
            </button>
          </div>
          ...
          <DropDown custom-class="topbar-item">
            <button type="button" class="topbar-button position-relative" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <Icon name="iconamoon:notification-duotone" class="fs-24 align-middle" />
