...
import { chatMsg, dropdownItem } from '~/pages/apps/chat/components/data'

import ContactOffcanvas from '~/pages/apps/chat/components/ContactOffcanvas.vue'
import ProfileOffcanvas from '~/pages/apps/chat/components/ProfileOffcanvas.vue'
