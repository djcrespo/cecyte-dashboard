...
import MailCard from '~/pages/apps/email/components/MailCard.vue'
import TabPane from '~/pages/apps/email/components/TabPane.vue'
import EmailSidebar from '~/pages/apps/email/components/EmailSidebar.vue'
import EmailRead from '~/pages/apps/email/components/EmailRead.vue'
import { emailData, emailTabs } from '~/pages/apps/email/components/data'
...
const filterMails = (ele: string, tab: string) => {
  let keyCheck = ''
