<template>
  <b-card no-body>
    <img class="card-img-top img-fluid" :src="item.image" alt="group-2" />
    <b-card-body>
      <h6>
        {{ item.date }}
      </h6>
      <b-card-title tag="h5" class="fs-16 lh-base mb-1">
...
import type { EventListType } from '~/pages/apps/social/components/types'

defineProps({
  item: {
    type: Object as PropType<EventListType>,
    required: true
  }
})
</script>
