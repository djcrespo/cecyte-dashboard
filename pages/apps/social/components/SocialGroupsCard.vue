<template>
  <b-card no-body class="group">
    ...
    <img class="card-img-top img-fluid" :src="item.image" alt="group-7" />
    <b-card-body>
      <b-card-title tag="h5" class="fs-16 mb-2">
        {{ item.title }}
      </b-card-title>
...
import type { GroupType } from '~/pages/apps/social/components/types'
