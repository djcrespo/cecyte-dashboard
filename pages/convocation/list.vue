<template>
  <PageBreadcrumb title="Lista de convocatorias" subtitle="Convocatorias" />
  <b-row>
    <b-col>
      <b-card no-body>
        <b-card-body>
          <div class="d-flex flex-wrap justify-content-between gap-3">
            ...
            <div>
              <NuxtLink to="/convocation/convocations/create" class="btn btn-primary d-flex align-items-center"> <i class="bx bx-plus me-1"></i>Agregar convocatoria </NuxtLink>
            </div>
          </div>
        </b-card-body>
        <div>
            ...
            <b-tbody>
              <b-tr v-for="(product, idx) in data.body" :key="idx">
                ...
                <b-td :class="product.inventory === 'active' ? 'text-primary' : product.inventory === 'in-process' ? 'text-success' : 'text-danger'">
                  ...
                  {{ product.inventory == 'active' ? 'Activo' : product.inventory == 'in-process' ? 'En proceso' : 'Inactivo' }}
                </b-td>
                <b-td>
...
import { data } from '~/pages/convocation/convocations/data'
