          ...
          <div class="p-3 pb-0">
            <template v-for="(item, idx) in sessionData" :key="idx">
              <div class="d-flex justify-content-between align-items-center">
                <p class="mb-1">
                  <Icon :name="item.country.icon" class="fs-16 align-middle me-1" />
...
import { sessionData, totalSessions, worldMapOptions } from '~/pages/dashboards/analytics/components/data'
