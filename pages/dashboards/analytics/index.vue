...
import StatisticsCard from '~/pages/dashboards/analytics/components/StatisticsCard.vue'
import SessionsByCountry from '~/pages/dashboards/analytics/components/SessionsByCountry.vue'
import SessionsByBrowser from '~/pages/dashboards/analytics/components/SessionsByBrowser.vue'
import TopPages from '~/pages/dashboards/analytics/components/TopPages.vue'

import { conversionsChart, performanceChart, statistics } from '~/pages/dashboards/analytics/components/data'
