...
import type { NewAccountTableType, RecentOrdersTableType, RecentTransactionsTableType, SalesByCategoryTableType } from '~/pages/dashboards/sales/components/types'
