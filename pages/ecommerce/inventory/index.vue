          ...
          <b-row>
            <b-col cols="12">
              <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <NuxtLink to="ecommerce/products/create" class="btn btn-primary d-inline-flex align-items-center ms-md-auto">
                ...
                <b-td>
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                      <NuxtLink :to="`/ecommerce/products/${inventory.id}`">
...
import { inventoryList } from '~/pages/ecommerce/inventory/components/data'
