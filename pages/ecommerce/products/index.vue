      ...
      <b-card no-body>
        <b-card-body>
          <div class="d-flex flex-wrap justify-content-between gap-3">
            ...
            <div>
              <NuxtLink to="/ecommerce/products/create" class="btn btn-primary d-flex align-items-center"> <i class="bx bx-plus me-1"></i>Add Product </NuxtLink>
            </div>
          </div>
        </b-card-body>
        <div>
...
import { products } from '~/pages/ecommerce/products/components/data'
