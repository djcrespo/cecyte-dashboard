                ...
                <b-table-simple class="mb-0">
                  ...
                  <b-tbody>
                    <b-tr>
                      ...
                      <b-td><b-badge :variant="null" class="bg-success-subtle text-success py-1 px-2">Verified</b-badge></b-td>
                    </b-tr>
                    <b-tr>
                      <b-td>3-128-2</b-td>
                      ...
                      <b-td><b-badge :variant="null" class="bg-warning-subtle text-warning py-1 px-2">Pending</b-badge></b-td>
                    </b-tr>
                    <b-tr>
                      <b-td>3-128-1</b-td>
                      ...
                      <b-td><b-badge :variant="null" class="bg-danger-subtle text-danger py-1 px-2">Rejected</b-badge></b-td>
                    </b-tr>
                  </b-tbody>
                </b-table-simple>
              </b-td>
